...
export const INITIAL_NOTE_CONTENT = `## Welcome to ThinkFlow

Start chatting on the right. 

I will automatically organize your thoughts, plans, and ideas here as we discuss them.`;
...
export const BOARD_MEMBERS = [
  { 
    ...
    name: 'Manager', 
    title: '思维中枢', 
    description: 'Orchestrator and meta-cognitive guide.', 
  ...
  { 
    ...
    name: 'Socrates', 
    title: '苏格拉底', 
    description: 'Challenge assumptions with probing questions.', 
  ...
  { 
    ...
    name: 'Feynman', 
    title: '费曼技巧', 
    description: 'The Great Explainer. Simple analogies.', 
  ...
  { 
    ...
    name: 'Pareto', 
    title: '80/20法则', 
    description: 'Focus on high-leverage points.', 
  ...
  { 
    ...
    title: '第一性原理', 
    description: 'Physics-based reasoning.', 
